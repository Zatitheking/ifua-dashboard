...
import { LayoutDashboard, Kanban, Users, BarChart3, Settings, ChevronLeft, ChevronRight, RotateCcw } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside
      ...
      } bg-[#1A1F2E] min-h-screen flex flex-col transition-all duration-300 shrink-0`}
    >
      {/* Logo */}
